...
import { X, Download, Drop, Play, Eye, Heart, ShareNetwork } from "@phosphor-icons/react";
...
export default function TikTokModal({
  ...
  const modalContent = (
    ...
    >
      <div
        className="bg-card-custom dark:bg-slate-900 w-full max-w-md rounded-xl shadow-lg overflow-hidden border border-primary/10 m-4"
